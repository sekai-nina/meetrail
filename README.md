...
- **計画** — 日 × 部のマトリックスを塗って申込計画を立て、上限や予算と突き合わせる
- **記録** — 当落・参加の記録と、話したいことのメモ・話題計画
- **売れ行きの可視化** — 自分の記録だけでなく、他ユーザーの記録を集計して各日程の売れ行きを推定する

3 つ目が中核です。1 人だと自分の申込結果しか分かりませんが、記録が集まると
「どの日程が埋まりやすいか」が見えるようになります。

| ホーム | 計画 | 売れ行き | 記録 | 話題計画 |
|---|---|---|---|---|
| ![ホーム](assets/shots/home.png) | ![計画](assets/shots/plan.png) | ![売れ行き](assets/shots/popularity.png) | ![記録](assets/shots/report.png) | ![話題計画](assets/shots/talk-plan.png) |

---

## 規模

判断材料として、素の数字を出します (2026 年 8 月時点)。

| | |
|---|---|
| TypeScript | 約 76,000 行 |
| 画面 | 50 |
| コンポーネント | 102 |
| DB マイグレーション | 96 |
| ユニットテスト | 128 ファイル |
| E2E シナリオ | 48 feature ファイル |
| DB テスト (pgTAP) | 43 ファイル |
| 開いている Issue | 183 |
| 直近 3 か月にマージした PR | 約 200 |
| 開発しているのは | 2 人 |
